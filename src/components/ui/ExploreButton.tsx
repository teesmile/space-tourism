...
export default function ExploreButton() {
  return (
      ...
      <Link  href='/destination' className=' cursor-pointer'>
       <button className="cursor-pointer w-38 h-38 rounded-full bg-white text-black flex items-center justify-center text-lg shadow-lg font-[var(--font-bellefair)-400] hover:text-black/80 hover:font-light transition-all duration-200">
        EXPLORE
      </button>
      </Link>
    </div>
